  ...
  return (
    <section aria-labelledby="cta-heading" className="relative overflow-hidden py-24 lg:py-32">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 60% 70% at 50% 120%, hsl(var(--primary) / 0.18), transparent 70%)',
        }}
      />
      <div
      ...
      <div className="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
        <SectionWrapper>
          ...
          <p className="mx-auto mt-5 max-w-xl text-lg text-muted-foreground">
            Have an opportunity, a project in mind, or just want to say hello? My inbox is always
            open.
          </p>
