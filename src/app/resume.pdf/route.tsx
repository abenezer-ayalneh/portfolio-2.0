...
function ResumeDocument() {
	...
	return (
		<Document title="Abenezer Ayalneh — Resume" author="Abenezer Ayalneh" subject="Resume">
				...
				<View style={styles.section} wrap={false}>
					...
					<View style={styles.projectsGrid}>
						{featuredProjects.map((p, idx) => (
							<View key={p.title} style={[styles.projectCell, idx % 2 === 1 ? styles.projectCellRight : {}]} wrap={false}>
...
export async function GET() {
	...
	return new Response(new Uint8Array(buffer), {
		...
		headers: {
			...
			'Content-Disposition': 'inline; filename="Abenezer Ayalneh -- Resume.pdf"',
